...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(storage, staticData) {
    ...
    AdminComponent.prototype.removePanel = function (i) {
...
var BeekeeperComponent = /** @class */ (function () {
    function BeekeeperComponent(formBuilder, storage, route) {
    ...
    BeekeeperComponent.prototype.ngOnInit = function () {
    ...
    BeekeeperComponent.prototype.toggle = function () {
        this.migrate = !this.migrate;
        console.log(this.migrate);
    };
    BeekeeperComponent.prototype.addFields = function () {
        this.fields.push({ state: '', crop: '' });
    };
    BeekeeperComponent.prototype.removeFields = function () {
        if (this.fields.length > 1) {
            this.fields.pop();
        }
    };
    BeekeeperComponent.prototype.create_UUID = function () {
    ...
    BeekeeperComponent.prototype.onSubmit = function () {
        var today = new Date();
        var date = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate();
        if (this.beekeeper.invalid) {
            var controls = this.beekeeper.controls;
            ...
            var submit = this.beekeeper.value;
    ...
    BeekeeperComponent.prototype.aadharUpload = function (fileInput) {
        var _this = this;
        var aadhar = fileInput.target.files[0];
        ...
        reader.onload = function (event) {
            ...
            _this.aadhar_url = reader.result;
            // console.log(this.url)
        };
        document.getElementById("aadhar_upload").innerText = aadhar.name;
    };
    BeekeeperComponent.prototype.photoUpload = function (fileInput) {
        var _this = this;
        var photo = fileInput.target.files[0];
        var reader = new FileReader();
        reader.readAsDataURL(fileInput.target.files[0]);
        //  To show the input image
        reader.onload = function (event) {
            // Url for the input image
            _this.pp_url = reader.result;
            // console.log(this.url)
        };
        document.getElementById("photo_upload").innerText = photo.name;
    };
    BeekeeperComponent.prototype.to_home = function () {
        this.route.navigate(['/']);
    };
    BeekeeperComponent.ctorParameters = function () { return [
...
var BexpanderComponent = /** @class */ (function () {
    function BexpanderComponent() {
    }
    BexpanderComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var OtherComponent = /** @class */ (function () {
    function OtherComponent(storage, route) {
        this.storage = storage;
        this.route = route;
    ...
    OtherComponent.prototype.create_UUID = function () {
        var dt = new Date().getTime();
    ...
    OtherComponent.prototype.onSubmit = function () {
        ...
        if (this.other_individual.invalid) {
            var controls = this.other_individual.controls;
            for (var name_1 in controls) {
                if (controls[name_1].invalid) {
                    console.log(name_1);
                }
            ...
            var submit = this.other_individual.value;
            this.uuid = this.create_UUID();
            submit['type'] = this.type;
            submit['category'] = this.category;
            submit['term'] = this.term;
    ...
    OtherComponent.prototype.onSelectFile = function (event) {
        console.log(event.value);
    };
    OtherComponent.prototype.aadharUpload = function (fileInput) {
        var _this = this;
        var aadhar = fileInput.target.files[0];
        console.log(fileInput.target.files);
        var reader = new FileReader();
    ...
    OtherComponent.prototype.photoUpload = function (fileInput) {
        var _this = this;
        var aadhar = fileInput.target.files[0];
        console.log(fileInput.target.files);
        var reader = new FileReader();
    ...
    OtherComponent.prototype.certUpload = function (fileInput) {
        var _this = this;
        var aadhar = fileInput.target.files[0];
        console.log(fileInput.target.files);
        var reader = new FileReader();
        ...
        reader.onload = function (event) {
            // Url for the input image
            _this.cret_utl = reader.result;
            // console.log(this.url)
        };
        document.getElementById("cert_upload").innerText = aadhar.name;
    };
    OtherComponent.prototype.cinUpload = function (fileInput) {
        var _this = this;
        var aadhar = fileInput.target.files[0];
        console.log(fileInput.target.files);
        var reader = new FileReader();
        ...
        reader.onload = function (event) {
            // Url for the input image
            _this.cin_url = reader.result;
            // console.log(this.url)
        };
        document.getElementById("cin_upload").innerText = aadhar.name;
    };
    OtherComponent.prototype.to_home = function () {
        this.route.navigate(['/']);
    };
    OtherComponent.ctorParameters = function () { return [
        { type: _services_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(formBuilder, staticData) {
        this.formBuilder = formBuilder;
        this.staticData = staticData;
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        ...
        this.registerForm.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(400), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])()).subscribe(function (res) {
        });
    };
    ...
    RegisterComponent.prototype.otherSubmit = function (status) {
        this.IndividualSubmit = status;
    };
    RegisterComponent.prototype.formSubmitted = function (status) {
        this.formSubmit = status;
    };
    RegisterComponent.prototype.onSubmit = function () {
        console.log(this.selected_category, this.selected_type, this.selected_term);
    };
    RegisterComponent.prototype.Selected = function (event) {
        console.log(this.selected_category, this.selected_type, this.selected_term);
...
var StaticService = /** @class */ (function () {
    ...
    StaticService.prototype.applicationType = function () {
        return this.application_type = [
            { value: '0', viewValue: 'New Application' },
            { value: '1', viewValue: 'Renew Application' },
        ];
    };
    StaticService.prototype.category = function () {
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.setItem = function (id, submit) {
        localStorage.setItem(id, submit);
        this.uuid.push(id);
        localStorage.setItem('uuids', JSON.stringify(this.uuid));
    };
    StorageService.prototype.getItem = function () {
        var uuids = JSON.parse(localStorage.getItem('uuids'));
    ...
    StorageService.prototype.removeData = function (i) {
        var uuids = JSON.parse(localStorage.getItem('uuids'));
        console.log(uuids[i]);
